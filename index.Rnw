...
\hh{XXX explicit null hypothesis under scenario 3 is: under the null hypothesis the distribution for selecting any plot from a lineup is given as
...
\svp{XXX not sure we need this paragraph anymore...}\dc{I like it}
