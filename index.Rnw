...
\hh{Under the null hypthesis, the data panel is not distribuishable from the null plots. We can therefore model the picking probabilities $\bm\theta$ for the panels of a lineup }
