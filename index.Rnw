...
A \svp{discussion} of this property \svp{and its application to visual inference} is provided in \Cref{neutrality}.% - is it worth it? \dc{Can we cite something instead? it must be somewhere in the lit?}
