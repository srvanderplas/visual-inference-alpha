...
Graphics provide the opportunity to understand statistical data at \dc{a (visual) sensory level. They are also important for data analysis because a plot can communicate more than what summary statistics can} \svp{convey}~\citep{anscombe:1972,matejka:2017}.
