...
\begin{description}
\item[\hh{Identify the number $c$-interesting null panels in the lineup of interest.}] \hh{Consider \autoref{fig:alpha-sim-curve}. Generally, this figure needs to be adjusted to match the number  $m_o$ of null panels and their corresponding number $K_o$ of null panel selections. }
