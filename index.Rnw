...
# alphas <- c(.001, .02, .05, 0.06, 0.07, 0.08, 0.09, .1, .5, 1, 2, 5, 20, 1000)
alphas <- exp(seq(-7, 7, by = .01)) # seq(0.001, 0.5, by = .001)
plot_alphas <- c(.001, .02, .05, .1, .5, 1, 2, 5, 20, 1000)
alphas <- c(alphas, plot_alphas) %>% sort() %>% unique()
...
prior_pred %>%
   dplyr::filter(alpha %in% plot_alphas) %>%
ggplot() +
