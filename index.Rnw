...
The Dirichlet-Multinomial mixture model (\autoref{eqn:full-model-specification})
%\dc{do you mean BM model? you haven't previously defined DM model.} 
provides this flexibility through the introduction of the hyperparameter $\alpha$.} 
