...
For examine, the scatterplots shown in the one target lineups in Figure \ref{fig:typesoflineups}b \svp{map} variable 1 to the $x$ axis and variable 2 to the $y$ axis, with the intent to study association between the two variables.
...
>>>>>>> 63e8db3002e8786cd1fc008efca64e472b7251e6
