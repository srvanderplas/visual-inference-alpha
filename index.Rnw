...
\end{align}
where $C$ is the number of data panel detections,  $K$ is the number of independent evaluations of the lineup~\citep{vinference,vanderplas:2017,loyAreYouNormal2015} and \hh{$B(., .)$ is the Beta function defined as:
\[
