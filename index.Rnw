...
This approach is simple, and a reasonably good approximation for assessing the significance of structure in a plot, but it fails to account for variations in the design of visual inference experiments with multiple observers.
